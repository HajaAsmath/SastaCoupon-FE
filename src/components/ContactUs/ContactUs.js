...
export default function ContactUs() {
  ...
  const handleOnSubmit = (e) => {
    ...
    setLoading(true);
    axios
      .post("/contactUs", createContactUsObject())
      .then((res) => {
        if (res.status === 200) {
          setMessage(
            "Form Uploaded Successfully. Team will repond to your query shortly"
          );
          setDialogOpen(true);
          setLoading(false);
        }
    ...
    >
      ...
      >
        <TextField
          ...
          helperText={
            formValues.customerName.error &&
            formValues.customerName.errorMessage
          }
        />
        <TextField
          sx={{ width: "40%", minWidth: 300 }}
          ...
          helperText={
            formValues.customerEmail.error &&
            formValues.customerEmail.errorMessage
          }
        />
        <TextField
          sx={{ width: "40%", minWidth: 300 }}
