...
lineHeight: '138.6%', textAlign: 'left', marginLeft: 10, marginBottom: 3}}>Top Questions</Typography>
        <Box sx={{maxWidth: '90%'}}>
            <Box sx={{marginLeft:10,marginBottom:3, maxWidth: 912,  borderRadius: '5px', textAlign: 'left', fontFamily: 'Poppins'}}>
                <Typography className="heading" sx={{ cursor: 'pointer', padding: '16px 0px', boxShadow: '0px 1px 6px 2px rgba(0, 0, 0, 0.1)'}}>
                ...
                <Typography sx={{ display: 'none', padding: '16px 15px', boxShadow: '0px 2px 5px -1px rgba(0, 0, 0, 0.25)'}}>
