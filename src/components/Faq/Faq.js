...
export default function Faq() {
    ...
    return <Box sx={{height: 700}}>
        <Typography sx={{color:'#3C286D', fontSize:48, fontWeight: 'bolder',fontFamily: 'patuaOne',
lineHeight: '138.6%', textAlign: 'left', marginLeft: 10, marginBottom: 3}}>FAQ</Typography>
        <Typography sx={{color:'#3C286D', fontSize:28, fontWeight: 'bolder',fontFamily: 'patuaOne',
lineHeight: '138.6%', textAlign: 'left', marginLeft: 10, marginBottom: 3}}>Top Questions</Typography>
        <Box sx={{maxWidth: '90%'}}>
            <Box sx={{marginLeft:10,marginBottom:3, maxWidth: 912, textAlign: 'left', fontFamily: 'Poppins'}}>
                <Typography className="heading" sx={{ cursor: 'pointer',borderRadius: '6px', padding: '16px 0px', boxShadow: '0px 1px 6px 2px rgba(0, 0, 0, 0.1)'}}>
                    <ExpandMoreIcon sx={{verticalAlign: 'middle', display: 'none'}}/>
                    <ExpandLessIcon className='active' sx={{verticalAlign: 'middle', display: 'none'}}/>
                    Can I sell  set any amout of price i want for my coupon?
                </Typography>
                <Typography sx={{ display: 'none', padding: '16px 15px',borderRadius: '6px', boxShadow: '0px 2px 5px -1px rgba(0, 0, 0, 0.25)'}}>
                    Yes you can. But it is advised to set a resonable price inorder to make your coupon sell.
                </Typography>
            </Box>
            <Box sx={{marginLeft:10, marginBottom:3, maxWidth: 912, textAlign: 'left', fontFamily: 'Poppins'}}>
                <Typography className="heading" sx={{ cursor: 'pointer',borderRadius: '6px', padding: '16px 0px', boxShadow: '0px 1px 6px 2px rgba(0, 0, 0, 0.1)'}}>
            ...
            <Box sx={{marginLeft:10, marginBottom:3, maxWidth: 912, textAlign: 'left', fontFamily: 'Poppins'}}>
                ...
                <Typography sx={{ display: 'none', padding: '16px 15px',borderRadius: '6px', boxShadow: '0px 2px 5px -1px rgba(0, 0, 0, 0.25)'}}>
                    You coupon code will be displayed to you once you complete the purchase.
                </Typography>
            </Box>
            <Box sx={{marginLeft:10, marginBottom:3, maxWidth: 912, textAlign: 'left', fontFamily: 'Poppins'}}>
                <Typography className="heading" sx={{ cursor: 'pointer',borderRadius: '6px', padding: '16px 0px', boxShadow: '0px 1px 6px 2px rgba(0, 0, 0, 0.1)'}}>
